...
export default function CategoryDetails() {
    ...
    const { isLoading, data } = useQuery('categoryDetails', CategoryDetails)
            ...
            {data?.data.data.map(function (product, idx) {
                return <div key={idx} className="col">
                    <div className="card h-100 product">
                        {/* make product details to catergoryDetails when we add our api */}
                        ...
                        <div className='d-flex justify-content-around align-items-center mb-2'>
                            ...
                            <Link><i ><i>{wishListStatus[product.id] ? (
                                <SolidHeart
